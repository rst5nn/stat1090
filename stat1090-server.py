...
ALLOWED_GRAPHS = {'stat1090', 'messages', 'messages_received', 'message_rate', 'aircraft', 'aircraft_seen', 'tracks', 'tracks_seen', 'adsb_tracks_seen', 'range', 'adsb_range', 'signal', 'signal_level', 'traffic', 'landings', 'departures', 'arrivals', 'temperature', 'temp'}
